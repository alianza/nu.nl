...
const useDarkThemeListener = (setDarkTheme) => {
    useEffect(() => {
        let observer = new MutationObserver(mutations => mutations.forEach(mutation => setDarkTheme(mutation.target.dataset.theme === "dark")))
...
const onColorSchemeChange = (e) => document.body.dataset.theme = e.matches ? 'dark' : '' // Prefers light/dark
